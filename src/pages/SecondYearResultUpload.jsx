...
const SecondYearResultUpload = () => {
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const response = await axios.post(
        BackendEndpoints.STUDENT_ACCOUNT_SECONDYEARRESULT_UPLOAD,
        formData,
        {
          headers: {
  ...
  return (
    ...
    >
      <ToastContainer />
      <ResultUploadForm year="Second Year" onSubmit={handleSubmit} />
      <ResultUploadModal
...
export default SecondYearResultUpload;
