...
const FirstYearResultUpload = () => {
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const response = await axios.post(
        BackendEndpoints.STUDENT_ACCOUNT_FIRSTYEARRESULT_UPLOAD,
        formData,
        {
          headers: {
  ...
  return (
    <div
      ...
      className="result-upload-parent-div"
    >
      <ToastContainer />
      <ResultUploadForm year="First Year" onSubmit={handleSubmit} />
      <ResultUploadModal
...
export default FirstYearResultUpload;
